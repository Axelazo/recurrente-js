...
export interface CreateCheckoutRequest {
  /**
   * An array of items to be included in the checkout, referencing existing product IDs.
   * @required
   */
  items: {
    /**
     * The ID of a pre-existing product in Recurrente.
     * @required
     */
    productId: string;
  }[];
  ...
  cancelUrl?: string;
  /**
   * The ID of the user to whom the checkout belongs. Pre-populates user info.
   * @optional
   */
  userId?: string;
  /**
